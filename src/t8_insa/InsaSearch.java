		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(ans == 0) {
					...
					if(res != 0) {
						JOptionPane.showMessageDialog(null, name+"회원 삭제완료!!");
						dispose();
						new InsaMain();
					}
					else JOptionPane.showMessageDialog(null, name+"회원 삭제실패~~");
				}
				else JOptionPane.showMessageDialog(null, name+"회원 삭제취소~~");
			}
		});
